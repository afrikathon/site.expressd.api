...
module.exports = {
 ...
 mongodb: {
   client: 'mongodb',
   connectionString: Env.get('DB_CONNECTION_STRING', 'mongodb+srv://toure5013:x7pjeFTThK1MdKYr@healthappapi-eclon.mongodb.net/api-db?retryWrites=true&w=majority'),
   connection: {
     host: Env.get('DB_HOST', 'localhost'),
     port: Env.get('DB_PORT', 27017),
     username: Env.get('DB_USER', 'root'),
     password: Env.get('DB_PASSWORD', 'x7pjeFTThK1MdKYr'),
